...
namespace MbientLab.MetaWear.Impl {
    [DataContract]
    class BarometerBme280 : BarometerBosch, IBarometerBme280 {
        internal const byte IMPLEMENTATION = 1;
        private static readonly float[] STANDBY_TIMES = new float[] {
            0.5f, 62.5f, 125f, 250f, 500f, 1000f, 10f, 20f
        };

        public BarometerBme280(IModuleBoardBridge bridge) : base(bridge) {
        }
