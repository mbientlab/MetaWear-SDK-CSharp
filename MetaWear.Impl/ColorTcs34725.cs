        ...
        private class AdcDataType : DataTypeBase {
            ...
            protected override DataTypeBase[] createSplits() {
                return new DataTypeBase[] {
                    new IntegralDataType(COLOR_DETECTOR, Util.setRead(ADC), NO_ID, new DataAttributes(new byte[] { 2 }, 1, 0, true)),
                    new IntegralDataType(COLOR_DETECTOR, Util.setRead(ADC), NO_ID, new DataAttributes(new byte[] { 2 }, 1, 2, true)),
                    new IntegralDataType(COLOR_DETECTOR, Util.setRead(ADC), NO_ID, new DataAttributes(new byte[] { 2 }, 1, 4, true)),
